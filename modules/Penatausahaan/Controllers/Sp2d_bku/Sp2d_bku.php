 ...
 */
class Sp2d_bku extends \Aksara\Laboratory\Core
{
	private $_table									= 'BKUSP2D';
	...
	{
		$header										= $this->_header();
		$this->set_title('BKU Surat Perintah Pencairan Dana')
		->set_description
		('
		...
		(
			array
			(
				'penatausahaan/sp2d_bku/sub_unit'		=> 'Sub Unit'
			)
		)
