		...
		foreach($results as $key => $val)
		{
			...
			$item					= '
				<div class="card ' . (isset($val->color) ? $val->color : 'bg-secondary') . ' mb-3">
					<a href="#collapse_' . $key . '" class="card-header p-2 text-' . (isset($val->color) && !in_array($val->color, array('bg-light', 'bg-white')) ? 'light' : 'secondary') . '" data-bs-toggle="collapse">
						<div class="row">
							<div class="col-2">
					...
					<div id="collapse_' . $key . '" class="collapse" data-bs-parent="#accordion">
