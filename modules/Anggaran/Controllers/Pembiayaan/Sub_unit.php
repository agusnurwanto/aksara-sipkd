<?php 
namespace Modules\Anggaran\Controllers\Pembiayaan;

/**
 * Anggaran > Pembiayaan > Sub Unit
 *
 * @since			version 1.0.0
...
class Sub_unit extends \Aksara\Laboratory\Core
{
	...
	public function index()
	{
		...
		->unset_column('UNITKEY, TYPE, KDLEVEL, AKROUNIT, ALAMAT, TELEPON, UNITKEYUK, UNITKEYSKPD')
		->unset_view('UNITKEY, TYPE, KDLEVEL, AKROUNIT, ALAMAT, TELEPON, UNITKEYUK, UNITKEYSKPD')
		->unset_action('create, update, delete')
		->set_field('NMUNIT', 'hyperlink', 'anggaran/pembiayaan', array('sub_unit' => 'UNITKEY'))
		->set_alias
		(
			array
			(
	...
	// 	('			
	// 		Sum(RASKB.NILAI) AS total
	// 	')		
	// 	->join
	// 	(
	// 		'DAFTUNIT',
	// 		'DAFTUNIT.UNITKEY = RASKB.UNITKEY'
	// 	)				
	// 	->get_where
	// 	(
	// 		'RASKB',
	// 		array
	// 		(
	// 			'RASKB.UNITKEY'						=> $params['pagu_sub_unit'],
	// 			'RASKB.KDTAHAP'						=> $tahap->KDTAHAP,
	// 		)
